# -*- coding: utf-8 -*-
# Generated by Django 1.10.3 on 2017-04-03 09:24
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('person', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='actor', to='movies.Person')),
            ],
        ),
        migrations.AddField(
            model_name='movie',
